...
{
    /// <summary>
    /// The SyncActiveChest (0x21) packet.
    /// </summary>
    public class SyncActiveChest : TerrariaPacket
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncActiveChest"/> class.
        /// </summary>
        public SyncActiveChest()
            : base((byte)PacketTypes.SyncActiveChest)
        {
        ...
        public SyncActiveChest(BinaryReader br)
            : base(br)
        {
        ...
        {
            return $"[SyncActiveChest: ChestID = {ChestID} ChestX = {ChestX} ChestY = {ChestY} NameLength = {NameLength} ChestName = {ChestName}]";
        }
