...
{
    /// <summary>
    /// The UpdateItemDrop2 (0x5A) packet.
    /// </summary>
    public class UpdateItemDrop2 : TerrariaPacket
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateItemDrop2"/> class.
        /// </summary>
        public UpdateItemDrop2()
            : base((byte)PacketTypes.UpdateItemDrop2)
        {
        ...
        public UpdateItemDrop2(BinaryReader br)
            : base(br)
        {
